...
import { useUserDeleteMutation } from '../../../../app/features/auth/authApi';
...
const SingleUser = ({ user }) => {
    ...
    return (
        <>
            ...
            {
                deletedUser && <DeleteConfirmModal
                    deletedData={deletedUser}
                    setDeletedData={setDeletedUser}
                    deleteSuccess={handleUserDelete}
                    dataType="User"
                >
                </DeleteConfirmModal>
            }
